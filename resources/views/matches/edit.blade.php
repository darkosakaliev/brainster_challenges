<x-app-layout>
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <h1 class="text-center text-5xl mb-6">Edit a match</h1>
            <div class="overflow-x-auto p-6 relative shadow-md sm:rounded-lg">
                <form action="{{ route('matches.update', $match->id) }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <select name="home_team_id" id="home_team_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                    ...
                    <div class="mb-6">
                        ...
                        <select name="guest_team_id" id="guest_team_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                            @foreach ($teams as $team)
                            <option value="{{$team->id}}" {{ ($team->id == $match->guest_team_id) ? 'selected' : '' }}>{{$team->name}}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="mb-6">
